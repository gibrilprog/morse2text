...
- Updated the word gap timing to 1000 ms and exposed a GUI `spacePending` state for future text insertion.
- Updated the GUI button area with an appui timer from 0 to 0.5 second, including a 0.2 second marker.
- Added an inactivity countdown bar labelled "Temps restant avant un espace".
