...
- The Morse2Text project needs a clean and testable base before adding real mouse capture or a physical device.
...
- This first version is logic-only, matching the requested software prototype.
- Real right-click capture and future mechanical input can be added on top of the current `ClickInterpreter`.
